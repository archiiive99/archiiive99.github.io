...
Personal website: https://archiiive99.github.io/

Static HTML, CSS, and JavaScript. Open `index.html` directly; no dependencies or build step. GitHub Pages publishes the root of `main`.
