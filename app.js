const publications = [
  ...
  {year:2025,venue:'CVPR 2025 Workshop',title:'Swin-Trajectory: Technical Report for 2025 Waymo Vision-based End-to-End Driving Challenge',authors:'Sungjin Park, Gwangik Shin, Jaeha Song, Sumin Lee, Hyukju Shon, Byounggun Park, Jinhee Na, Hawook Jeong, Soonmin Hwang',description:'3rd place in the 2025 Waymo Vision-based End-to-End Driving Challenge.',equalAuthors:3,thumbnail:'assets/swin-figure.png',links:[['Paper','https://storage.googleapis.com/waymo-uploads/files/research/2025%20Technical%20Reports/2025%20WOD%20E2E%20Driving%20Challenge%20-%203rd%20Place%20-%20Swin-Trajectory.pdf']]},
  {year:2025,venue:'ICAIIC 2025',title:'Efficient Occupancy Prediction with Instance-Level Attention',authors:'Sungjin Park, Jaeha Song, Soonmin Hwang',equalAuthors:2,thumbnail:'assets/occupancy-figure.png',links:[['Paper','https://ieeexplore.ieee.org/document/10920673']]},
  {year:2025,venue:'ICAIIC 2025',title:'Leveraging Camera-Based Methods for Enhanced Feature-to-World Mapping',authors:'Jaeha Song, Sungjin Park, Soonmin Hwang',equalAuthors:2,thumbnail:'assets/mapping-figure.png',links:[['Paper','https://ieeexplore.ieee.org/document/10920789']]},
...
const renderAuthors = (authors,equalAuthors=0) => authors.split(', ').map((name,index,names) => `<span class="author-name">${name === 'Jaeha Song' ? `<strong>${escapeHTML(name)}</strong>` : escapeHTML(name)}${index<equalAuthors?'<sup title="Equal contribution">*</sup>':''}${index < names.length-1 ? ',' : ''}</span>`).join(' ');
